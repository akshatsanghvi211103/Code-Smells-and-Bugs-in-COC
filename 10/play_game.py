...
while(1):
    ...
    if d == None:
        ...
        if ch == None:
            ...
            index = int(ch[6])
            c[index - 1][0] = c[index - 1][0] - kp
            os.system('aplay -q ./sounds/sword.wav& 2>/dev/null')
            check_health(c[index-1],count,ch,obj_board.get_grid(),obj_obs.get_grid())
            ...
            index = int(ch[6])
            h[index - 1][0] = h[index - 1][0] - kp
            os.system('aplay -q ./sounds/sword.wav& 2>/dev/null')
            check_health(h[index-1],count,ch,obj_board.get_grid(),obj_obs.get_grid())
            # if(ch[4]=='1'):
            #     h1[0]=h1[0]-kp
            #     os.system('aplay -q ./sounds/sword.wav& 2>/dev/null')
            #     if(h1[0]<=0):
            ...
            th[0]=th[0]-kp
            os.system('aplay -q ./sounds/sword.wav& 2>/dev/null')
            check_health(th,count,ch,obj_board.get_grid(),obj_obs.get_grid())
            # if(th[0]<=0):
            #     disappear.delete_ele(obj_board.get_grid(),obj_obs.get_grid(),ch) 
            #     count[0]+=1
